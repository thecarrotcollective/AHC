<?php
  ...
  function has_unique_item($client, $collection, $itemname) {
    global $db;

    $sql = "SELECT * FROM analytics ";
    $sql .= "WHERE client='" . db_escape($db, $itemname) . "' ";
    $sql .= "AND collection = '" . db_escape($db, $client) . "'";
    $sql .= "AND itemname = '" . db_escape($db, $collection) . "'";
